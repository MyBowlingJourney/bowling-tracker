...
const RESPONSE_SCHEMA = {
  ...
  properties: {
    ...
    writtenNotes: {
      type: "array",
      description: "Every note written or typed ON TOP OF the screenshot by the bowler -- not part of the app's own scorecard, names, headings, place, date or scores. Usually pin numbers such as \"4\", \"10\" or \"1-3-6\" written beside or below a game. Empty if there are none.",
      items: {
        type: "object",
        properties: {
